...
{
    public partial class Pizzafood : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            userShowLB.Text = Session["account"] + " 歡迎光臨必輸客，您餘額還有" + Session["money"] + "元";
        ...
        protected void orderFoodGridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
