<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pizzafood.aspx.cs" Inherits="FinalProject.Pizzafood" %>
...
<body style="background-image: url('pic/點餐頁面2.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-position: center;  background-size:cover;">
    <form id="form1" runat="server">
        <table class="auto-style1">
            <tr>
                <td class="auto-style43">
                    <asp:Image ID="Image1" class="circle" runat="server" ImageAlign="Middle" alt="" Height="26px" Width="24px"/>
                    <asp:Label ID="userShowLB" runat="server" CssClass="auto-style6" Text="將顯示使用者資料"></asp:Label>
                    </td>
                <td class="auto-style42"><strong>必輸客</strong></td>
                <td class="auto-style37" style="vertical-align: top">
            ...
            <tr>
                <td class="auto-style44" style="vertical-align: top">
                    ...
                    <asp:GridView ID="orderFoodGridView" runat="server" AutoGenerateColumns="False" DataSourceID="orderFoodDataSource" CssClass="auto-style26" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDataBound="orderFoodGridView_RowDataBound" DataKeyNames="orderItem_id" OnRowDeleted="orderFoodGridView_RowDeleted" OnRowUpdated="orderFoodGridView_RowUpdated" OnRowDeleting="orderFoodGridView_RowDeleting" OnSelectedIndexChanged="orderFoodGridView_SelectedIndexChanged" HorizontalAlign="Center">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="數量" SortExpression="orderItem_qt">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("orderItem_qt") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="單價" SortExpression="food_price">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("food_price") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
        ...
        <asp:SqlDataSource ID="foodDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [food_name], [food_price] FROM [foodTable] WHERE ([food_kind] = @food_kind)">
            <SelectParameters>
                <asp:Parameter DefaultValue="2" Name="food_kind" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="startOrderDataSource" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            InsertCommand="INSERT INTO orderTable(order_area, order_member_account, order_member_phone, order_kind) VALUES (@order_area, @order_member_account, @order_member_phone, 2)" 
